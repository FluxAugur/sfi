...
namespace :foreman do
  ...
  task :export, roles: :app do
    run "cd #{current_path} && foreman export bluepill --no-privileged --base-dir #{shared_path}/log/ --logfile #{shared_path}/log/bluepill.log /data/#{application}/shared/config"
